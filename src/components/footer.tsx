      ...
      <div className="max-w-[87rem] container mx-auto px-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-primary-foreground/80">9:00 AM - 10:00 PM</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Tuesday</span>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center">
          <p className="text-primary-foreground/60 text-sm">
            © {currentYear} MASALA DOSA. All rights reserved. | Authentic South Indian Restaurant in Milpitas, CA
          </p>
        </div>
      </div>
    </footer>
